...
module.exports = {
  ...
  getRecipe: async (req, res) => {
    try {
      ...
      //example url : http://localhost:2121/post/640e25ac53c3eb07ffb1e714
      //id === 640e25ac53c3eb07ffb1e714
  ...
  createRecipe: async (req, res) => {
    try {
      ...
      //media is stored on cloudinary - the avobe request responds with url to media and the media id that you will need when deleting content
      await Recipe.create({
        name: req.body.name,
